...
public final class ActivityNotificationsBinding implements ViewBinding {
  ...
  private ActivityNotificationsBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView navHome, @NonNull RecyclerView notificationsRecycler,
      @NonNull TextView textView6, @NonNull View view7) {
    this.rootView = rootView;
    this.navHome = navHome;
    this.notificationsRecycler = notificationsRecycler;
  ...
  public static ActivityNotificationsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.notifications_recycler;
      RecyclerView notificationsRecycler = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityNotificationsBinding((ConstraintLayout) rootView, navHome,
          notificationsRecycler, textView6, view7);
    }
